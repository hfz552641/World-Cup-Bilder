...
Euro = ["Austria", "Belgium", "Bulgaria", "Croatia", "Denmark", "England", "France", "Germany", "Iceland", "Ireland", "Italy", "Netherlands", "Northern Ireland",
        "Poland", "Portugal", "Romania", "Russia", "Scotland", "Serbia", "Slovakia", "Spain", "Sweeden", "Switzerland", "Turkey", "Ukraine", "Wales"]
Afro = ["CDR", "Egypt", "Morocco", "Nigeria", "Senegal", "Tunisia"]
SA = ["Argentina", "Brazil", "Chile", "Colombia", "Paraguay", "Peru", "Uruguay"]
NA = ["Costa Rica", "Mexico", "Panama", "USA"]
Asia = ["Australia", "Iran", "Japan", "South Korea", "KSA"]
Oceania = []
...
root = tk.Tk()
root.title("World Cup : Stickman Soccer 18")
